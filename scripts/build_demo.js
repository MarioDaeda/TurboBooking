...
fs.writeFileSync(rootPath, outputHtml, 'utf8');
console.log('Saved demo HTML to:', rootPath);

// Also save to frontend/public for dev server access
const publicPath = path.join(rootDir, 'frontend/public/TurboBooking-Demo.html');
fs.writeFileSync(publicPath, outputHtml, 'utf8');
console.log('Saved demo HTML to:', publicPath);
