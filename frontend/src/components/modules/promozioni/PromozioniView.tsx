...
export const PromozioniView: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'attive' | 'non-attive'>('attive');
    ...
    <div className="flex-1 flex h-full bg-white overflow-hidden select-none">
      ...
      <div className="w-80 border-r border-gray-200 flex flex-col bg-white">
        <div className="flex border-b border-gray-200 text-xs font-semibold">
          ...
          <button
            onClick={() => setActiveTab('non-attive')}
            className={`flex-1 py-3 text-center border-b-2 transition ${
              activeTab === 'non-attive'
                ? 'border-tw-blue text-tw-blue'
                : 'border-transparent text-gray-500 hover:text-gray-800'
            }`}
          >
        ...
        <div className="p-4 flex-1 flex flex-col">
          <div className="flex items-center gap-2 mb-3">
            ...
            <button
              onClick={() => alert('Crea nuova promozione')}
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-tw-canvas">
        <div className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <div className="text-xs text-gray-500">
            Seleziona una promozione dall&apos;elenco o{' '}
            <button
              onClick={() => alert('Aggiungi nuova promozione')}
